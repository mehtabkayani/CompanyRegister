...
import CompanyEntity.entity.Company;
import CompanyEntity.entity.Employee;
...
//    }
    ...
    @Path("{companyId}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void createEmployee(@PathParam("companyId") Integer id, Employee entity) {

        Company company = em.find(Company.class, id);
        company.setId(id);
        entity.setCompanyId(id);
        create(entity);
        company.addEmployee(entity);
    }
